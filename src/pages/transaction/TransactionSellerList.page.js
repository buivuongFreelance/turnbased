...
import TransactionSellerList from "../../components/transaction/TransactionSellerList.component";

class TransactionSellerListPage extends Component {
  constructor(props) {
    super(props);
...
export default withApp((withRouter(TransactionSellerListPage)));
